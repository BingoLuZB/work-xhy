...
const list = {
    '马甲91（梵天仙决）/js': {
        // 0.9 base64 短字符串
        'protobufbundles.min': './梵天仙决/js/protobuf-bundles.min.js',
        'protobuflibrary.min': './梵天仙决/js/protobuf-library.min.js',
    },
    '马甲91（梵天仙决）/stage1': {
        'main.min': './梵天仙决/stage1/main.min.js',
    },
    '马甲91（梵天仙决）/stage2': {
        'default.thm.min': './梵天仙决/stage2/default.thm.min.js', 
    },
}
