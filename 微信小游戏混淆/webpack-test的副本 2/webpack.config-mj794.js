...
const list = {
    '马甲794（至尊仙灵）/stage1': {
        'default.thm': `./${name}/stage1/default.thm.js`, //base64
    },
    '马甲794（至尊仙灵）/stage2': {
        'default2.thm.2': `./${name}/stage2/default.thm.2.js`, //base64
    },
    '马甲794（至尊仙灵）/stage3': {
        'main': `./${name}/stage3/main.js`, //base64
    },
    '马甲794（至尊仙灵）/stage4': {
        'main2.2': `./${name}/stage4/main.2.js`, //base64
    },
}
// entry.min.js,main.min.js,subpack.min.js
const mjConfig = {
    //终极方法
