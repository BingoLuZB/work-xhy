...
var SelServerPanelExt=(function(_super){
	function SelServerPanelExt(){
		...
		if(Browser.IszhijianWeChat)
			this.imgbg.skin="res/ui/image/boot/changeweiMini.jpg";
