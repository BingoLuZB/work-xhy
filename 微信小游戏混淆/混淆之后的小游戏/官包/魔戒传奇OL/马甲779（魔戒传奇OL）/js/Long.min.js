var egret = window.egret;! function () {
    ! function (t) {
        function i(t, i, r) {
        ...
        i.fromInt = function (t, e) {
            ...
            for (var o = i.ZERO, s = 0; s < t.length; s += 8) {
                var h = Math.min(8, t.length - s),
                    u = parseInt(t.substring(s, s + h), n);
                8 > h ? (h = i.fromNumber(Math.pow(n, h)), o = o.multiply(h).add(i.fromNumber(u))) : (o = o.multiply(e), o = o.add(i.fromNumber(u)))
            }
        ...
        var e = 0x10000000000000000,
            o = e / 2,
            s = i.fromInt(16777216);
        i.ZERO = i.fromInt(0), i.UZERO = i.fromInt(0, !0), i.ONE = i.fromInt(1), i.UONE = i.fromInt(1, !0), i.NEG_ONE = i.fromInt(-1), i.MAX_VALUE = i.fromBits(-1, 2147483647, !1), i.MAX_UNSIGNED_VALUE = i.fromBits(-1, -1, !0), i.MIN_VALUE = i.fromBits(0, -2147483648, !1), i.prototype.toInt = function () {
            ...
            for (var e = "";;) {
                var o = r.div(n),
                    s = (r.subtract(o.multiply(n)).toInt() >>> 0).toString(t);
            ...
            var r, n = this.high >>> 16,
                e = 65535 & this.high,
                o = this.low >>> 16,
                s = t.high >>> 16,
                h = 65535 & t.high,
                u = t.low >>> 16;
            return r = 0 + ((65535 & this.low) + (65535 & t.low)), t = 0 + (r >>> 16), t += o + u, o = 0 + (t >>> 16), o += e + h, e = 0 + (o >>> 16), e = e + (n + s) & 65535, i.fromBits((65535 & t) << 16 | 65535 & r, e << 16 | 65535 & o, this.unsigned)
            ...
            t = 65535 & t.low;
            var f, a, l, m;
            return m = 0 + o * t, l = 0 + (m >>> 16), l += e * t, a = 0 + (l >>> 16), l = (65535 & l) + o * g, a += l >>> 16, l &= 65535, a += n * t, f = 0 + (a >>> 16), a = (65535 & a) + e * g, f += a >>> 16, a &= 65535, a += o * u, f += a >>> 16, a &= 65535, f = f + (r * t + n * g + e * u + o * h) & 65535, i.fromBits(l << 16 | 65535 & m, f << 16 | a, this.unsigned)
            ...
            var r, n, e;
            if (this.equals(i.MIN_VALUE)) return t.equals(i.ONE) || t.equals(i.NEG_ONE) ? i.MIN_VALUE : t.equals(i.MIN_VALUE) ? i.ONE : (r = this.shiftRight(1).div(t).shiftLeft(1), r.equals(i.ZERO) ? t.isNegative() ? i.ONE : i.NEG_ONE : (n = this.subtract(t.multiply(r)), e = r.add(n.div(t))));
            ...
            for (e = i.ZERO, n = this; n.greaterThanOrEqual(t);) {
                ...
                for (var o = Math.ceil(Math.log(r) / Math.LN2), o = 48 >= o ? 1 : Math.pow(2, o - 48), s = i.fromNumber(r), h = s.multiply(t); h.isNegative() || h.greaterThan(n);) r -= o, s = i.fromNumber(r, this.unsigned), h = s.multiply(t);
