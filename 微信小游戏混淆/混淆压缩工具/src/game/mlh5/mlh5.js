export default class MLH5 {
  constructor() {
    this.systemArgs = {
      sdkHost: "https://sdk.silanggame.com",
      wxAppId: "",
      wxAppType: "wxApp",
      appId: 0,
      channelId: 0,
 ...
 //登录按钮
  ...
  login(opts) {
    ...
    if (_this.systemArgs.initFlag == false) {
      ...
      setTimeout(function () { login(opts) },2000);
      return;
    }
    ...
    this.request({
      ...
      callback: res => {
        ...
        if (payData.tradeType == "KFPAY") {
          wx.showModal({
            title: "温馨提示",
            content: "订单号：" + payData.orderId + "\n请按确定后进入客服窗口，如果未收到本订单支付入口，请发送窗口右下角卡片获取.祝你游戏愉快!",
            confirmText: "确定",
            showCancel: false,
            success: () => {
              var sftmp = {
                ...
                title: "订单支付",
                img: "https://apk-1255812642.cos.ap-guangzhou.myqcloud.com/img/dhfz.png"
              };
              wx.openCustomerServiceConversation({
                ...
                sendMessageImg: "https://apk-1255812642.cos.ap-guangzhou.myqcloud.com/img/dhfz.png",
                success: (res) => {
                  console.log(res);
                }
              });
